...
namespace PortalBusinessRulesCustomizations
{
    ...
    public class JavascriptGeneratorWA : CodeActivity
    {
        ...
        //                RuleJSGenerator generator = new RuleJSGenerator(service, tracingService, entityName, ruleId, ruleName);
        ...
        //                string autoGeneratedJS = generator.GenerateJavacript(operand1LogicalName, 0, operand2Value, operand1Type, positiveJson, negativeJson);

        //                formCustomJS = CleanFormJSFromExistingRule(tracingService, generator.CurrentRuleStartBlock, generator.CurrentRuleEndBlock, formCustomJS);
